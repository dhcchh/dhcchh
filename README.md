...
Economics graduate from Singapore Management University, now starting out in data engineering. I came to it from the analytics side — enough time spent downstream of messy, unreliable data to want to work on the layer that fixes it.
...
- **Orchestration** — Airflow/Dagster: production-grade scheduling, backfills, and reproducible reruns.
- **dbt** — modelling, testing, and documenting warehouse layers properly.
...
| **Pipelines** | dbt, Airflow *(learning)* |
...
Wise case study on cross-border card economics: interchange and FX revenue weighed against transaction cost.
